...
class CarDetailsFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val model=arguments?.getString("com/clovertech/autolibdz/model")
        car.text=model
        ...
        button.setOnClickListener {view->
         ...
         val bundle = bundleOf("id" to idcar,"img" to img,"com/clovertech/autolibdz/model" to model, "hr" to uni_hr, "jr" to uni_jr,
            "brand" to brand)
